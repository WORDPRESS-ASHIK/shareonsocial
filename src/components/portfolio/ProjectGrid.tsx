...
export function ProjectGrid({ projects }: { projects: Project[] }) {
  if (projects.length === 0) {
    return (
      <div className="mx-auto max-w-[1400px] px-6 md:px-10 mb-24 md:mb-32 text-center py-20 border border-foreground/10 rounded-[2rem]">
  ...
  return (
    <section className="mx-auto max-w-[1400px] px-6 md:px-10 mb-24 md:mb-32">
      <div className="flex items-center gap-3 text-xs uppercase tracking-[0.25em] text-foreground/50 mb-10">
